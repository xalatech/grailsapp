//
// Beregnet på local JBoss installasjon på Windows
//
...
localSystemKommandoPath = "C:\\SIV\\filer\\systemkommando\\klient"
serverSystemKommandoPath = "C:\\SIV\\filer\\systemkommando\\server"
...
sil.sap.fil.lokal.katalog = "C:\\SIV\\filer\\systemkommando\\temp\\sap"
...
utvalg.eksport.fil.path = "C:\\SIV\\filer\\utvalg\\"
...
//  06.03.2014 vak : Byttet ut hsqldb med h2 (oppgradering til grails 2.2.4)
...
dataSource {
	// dbCreate = "update" // one of 'create', 'create-drop','update'. any other value (like none) - does nothing
