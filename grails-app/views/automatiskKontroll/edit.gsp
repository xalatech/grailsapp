...
<html>
    ...
    <body>
        <div class="body">
            ...
            <g:form method="post" >
                <g:hiddenField name="id" value="${automatiskKontrollInstance?.id}" />
                <g:hiddenField name="version" value="${automatiskKontrollInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: automatiskKontrollInstance, field: 'produktNummer', 'errors')}">
                                    <g:select name="produktNummer" from="${produktNummerListe}" optionKey="produktNummer" value="${automatiskKontrollInstance?.produktNummer}" />
                                </td>
                            </tr>
