                        ...
                        <tbody>
                         ...
                         <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="prosjektNavn"><g:message code="prosjekt.prosjektNavn.label" default="Prosjektnavn" /></label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="oppstartDato"><g:message code="prosjekt.oppstartDato.label" default="Oppstartsdato" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: prosjektInstance, field: 'oppstartDato', 'errors')}">
                                    <g:datoVelger id="od" name="oppstartDato"/>
                                </td>
                            </tr>
                              ...
                              <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: prosjektInstance, field: 'avslutningsDato', 'errors')}">
                                    <g:datoVelger id="ad" name="avslutningsDato"/>
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: prosjektInstance, field: 'kommentar', 'errors')}">
                                    <g:textField name="kommentar" value="${prosjektInstance?.kommentar}" />
                                </td>
                            </tr>
