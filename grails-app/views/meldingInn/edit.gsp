    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${meldingInnInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: meldingInnInstance, field: 'meldingInnType', 'errors')}">
                                    <g:select name="meldingInnType" from="${siv.type.MeldingInnType?.values()}" value="${meldingInnInstance?.meldingInnType}"  />
                                </td>
                            </tr>
