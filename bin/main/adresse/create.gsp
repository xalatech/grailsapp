                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: adresseInstance, field: 'husBruksNummer', 'errors')}">
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="gateGaardNummer"><g:message code="adresse.gateNummer.label" default="Gate-/gårdsnummer" /></label>
                                </td>
