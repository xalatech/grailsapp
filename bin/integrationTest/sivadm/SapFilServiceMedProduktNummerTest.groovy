...
// Denne testen baserer seg på gamle produktnumre og vil feile
// Ligger her av historiske årsaker

// Kan godt slettes ettervert som ny løsning er konsolidert

@Ignore
class SapFilServiceMedProduktNummerTest extends GroovyTestCase {
    ...
    protected void setup() {
        ...
        prosjektMarked.produktNummer = "4567"
        ...
        proStatMarked.produktNummer = "9876"
    ...
    */
    ...
    void testGenererKravLinjeProduktStat() {
        Produkt produktFagforening = new Produkt(navn: "Fagforeningsarbeid", produktNummer: "3220-0", finansiering: ProsjektFinansiering.STAT, prosentStat: 100, prosentMarked: 0)
    ...
    void testGenererKravLinjeProduktStatMarked() {
        Produkt produktAdmin = new Produkt(navn: "Administrasjon", produktNummer: "1004-0", finansiering: ProsjektFinansiering.STAT_MARKED, prosentStat: 50, prosentMarked: 50)
